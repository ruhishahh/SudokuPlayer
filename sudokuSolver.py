...
'''
Prints out formatted version of sudoku board
'''
def showBoard(board):
...
'''
Checks if move is valid row-wise
'''
...
'''
Checks if move is valid column-wise
'''
...
'''
Checks if move is valid 3x3 square-wise
'''
...
'''
Checks if move is valid using helper functions
'''
